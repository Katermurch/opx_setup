...
# Network parameters #
######################
qop_ip = '10.225.208.35'  # Write the QM router IP address
...
#############################################
# Qubits LO
qubit_LO_q1 = 4.6 * u.GHz
qubit_LO_q2 = 4.6 * u.GHz
# Qubits IF
qubit_IF_q1 = -113 * u.MHz - 4.09 * u.MHz
qubit_IF_q1_ef = -259.5 * u.MHz
qubit_IF_q2 = (-155.36 * u.MHz )+ (24.360 * u.kHz) + (-10.517 * u.kHz)
# Qubits_delay)
qubit_delay_q1 = 0
qubit_delay_q2 = 0

# Mixer parameters
mixer_qubit_g_q1 = -0.009
mixer_qubit_g_q2 = -0.009
mixer_qubit_phi_q1 = 1.475
mixer_qubit_phi_q2 = 1.475

# Relaxation time
qubit1_T1 = int(1 * u.us)
qubit2_T1 = int(38 * u.us)
thermalization_time = 5 * max(qubit1_T1, qubit2_T1)

# CW pulse parameter
const_len = 1000
const_amp = 0.25/2 #300mV qubit spec

#gaussan swap parameters
gauss_swap_len = 16
gauss_swap_amp = 0.41
...
# DRAG coefficients
drag_coef_q1 = 1.98 #note that this is strange that it is so large
drag_coef_q2 = 0
anharmonicity_q1 = -142 * u.MHz
anharmonicity_q2 = -180 * u.MHz
AC_stark_detuning_q1 = 0 * u.MHz
AC_stark_detuning_q2 = 0 * u.MHz

# DRAG waveforms
gauss_swap_wf, _ = np.array(
    drag_gaussian_pulse_waveforms(gauss_swap_amp, gauss_swap_len, 7, 0,0, 0)
)
...
resonator_band = 3
# Resonators LO
resonator_LO = 6.6247 * u.GHz
# Resonators IF
resonator_freq_q1=  6.72728 * u.GHz#6.72734 * u.GHz
resonator_freq_q2 = 6.6554 * u.GHz
resonator_IF_q1 = 102.535*u.MHz
resonator_IF_q2 =30.775000 * u.MHz - 0.1 * u.MHz
print(resonator_IF_q2)

print(f"resonator_IF_q1: {resonator_IF_q1}, resonator_IF_q2: {resonator_IF_q2}")
# resontor_delay
resonator_delay = 0
...
time_of_flight = 28 + 256 # must be a multiple of 4
depletion_time = 5 * u.us

# Mixer parameters
mixer_resonator_g_q1 = -0.045
mixer_resonator_g_q2 = -0.037
mixer_resonator_phi_q1 = 1.656
mixer_resonator_phi_q2 = 1.672
...
if opt_weights:
    ...
    weights_q2 = np.load("optimal_weights_rr2.npz")
    ...
    opt_weights_real_q1 = [(1.0, readout_len_q1)]
    opt_weights_minus_imag_q1 = [(0.0, readout_len_q1)]
    opt_weights_imag_q1 = [(0.0, readout_len_q1)]
    opt_weights_minus_real_q1 = [(-1.0, readout_len_q1)]
    opt_weights_real_q2 = [(1.0, readout_len_q2)]
    opt_weights_minus_imag_q2 = [(0.0, readout_len_q2)]
    opt_weights_imag_q2 = [(0.0, readout_len_q2)]
    opt_weights_minus_real_q2 = [(-1.0, readout_len_q2)]

# state discrimination
rotation_angle_q1 = (51.6 / 180) * np.pi
rotation_angle_q1_gf = (79.0 / 180) * np.pi
rotation_angle_q2 = (202.2/ 180) * np.pi
ge_threshold_q1 = -3.068e-04
ge_threshold_q1_ef= 2.658e-04
ge_threshold_q2 =  -1.096e-03


#coupler control 
const_flux_len = 39*4 * u.ns
const_flux_amp = 154*u.mV #160 * u.mV
coupler_drive_freq = -19.1 * u.MHz
...
config = {
    ...
    "controllers": {
        "con1": {
            "analog_outputs": {
                1: {"offset": -0.00927},  # I qubit1 XY
                2: {"offset": -0.00715},  # Q qubit1 XY
                3: {"offset": -0.0214},  # I qubit2 XY
                4: {"offset": -0.0195},  # Q qubit2 XY
                5: {"offset": -0.017},  # C1 flux control line
                6: {"offset": 0},  # Q readout line
            },
            "digital_outputs": {
                1: {},
            },
            "analog_inputs": {
                1: {"offset": 0.0236, "gain_db": 0},  # I from down-conversion
                2: {"offset": 0.0214, "gain_db": 0},  # Q from down-conversion
            },
        },
    },
    "elements": {
        ...
        "q1_xy_ef": {
            "mixInputs": {
                ...
                "Q": ("con1", 4),
                "lo_frequency": qubit_LO_q1,
                "mixer": "mixer_qubit_q1_ef",
            },
            "intermediate_frequency": qubit_IF_q1_ef,  # in Hz
            "operations": {
                "cw": "constant_q1_ef",
                "x180_ef": "x_180_pulse_q1_ef",
            },
        },
        "q2_xy": {
            "mixInputs": {
        ...
        "coupler_1": {
            ...
            'intermediate_frequency': coupler_drive_freq,
            "operations": {
                "const": "const_flux_pulse",
                "gaussian": "gauss_pulse",
            },
        },
        "cr_drive_c1t2": {
            "mixInputs": {
    ...
    "pulses": {
        ...
        "gauss_pulse":{
            'operation': 'control',
            'length': gauss_swap_len,
            'waveforms':{
                'single': 'gauss_swap_wf',
            },
        },
        "x90_pulse_q1": {
            "operation": "control",
        ...
        "readout_pulse_q1": {
            ...
            "integration_weights": {
                ...
                "rotated_cos_q1": "rotated_cosine_weights_q1",
                "rotated_sin_q1": "rotated_sine_weights_q1",
                "rotated_minus_sin_q1": "rotated_minus_sine_weights_q1",
        ...
        "readout_pulse_q2": {
            ...
            "integration_weights": {
                ...
                "sin": "sine_weights",
                "minus_sin": "minus_sine_weights",
                "rotated_cos_q2": "rotated_cosine_weights_q2",
                "rotated_sin_q2": "rotated_sine_weights_q2",
                "rotated_minus_sin_q2": "rotated_minus_sine_weights_q2",
    ...
    "waveforms": {
        ...
        'gauss_swap_wf': {'type': 'arbitrary', 'samples': gauss_swap_wf.tolist()},
        'const_q1_ef_wf': {"type": "constant", "sample": pi_amp_q1_ef},
        ...
        "x180_I_wf_q1_ef": {"type": "constant", "sample": pi_amp_q1_ef},
        "x180_Q_wf_q1_ef": {"type": "constant", "sample": pi_amp_q1_ef},
    ...
    "integration_weights": {
        "cosine_weights": {
            "cosine": [(1.0, readout_len_q1)],
            "sine": [(0.0, readout_len_q1)],
        },
        "sine_weights": {
            "cosine": [(0.0, readout_len_q1)],
            "sine": [(1.0, readout_len_q1)],
        },
        "minus_sine_weights": {
            "cosine": [(0.0, readout_len_q1)],
            "sine": [(-1.0, readout_len_q1)],
        ...
        "rotated_cosine_weights_q1": {
            "cosine": [(np.cos(rotation_angle_q1), readout_len_q1)],
            "sine": [(np.sin(rotation_angle_q1), readout_len_q1)],
        },
        "rotated_sine_weights_q1": {
            "cosine": [(-np.sin(rotation_angle_q1), readout_len_q1)],
            "sine": [(np.cos(rotation_angle_q1), readout_len_q1)],
        },
        ...
        "rotated_cosine_weights_q2": {
            "cosine": [(np.cos(rotation_angle_q2), readout_len_q2)],
            "sine": [(np.sin(rotation_angle_q2), readout_len_q2)],
        },
        "rotated_sine_weights_q2": {
            "cosine": [(-np.sin(rotation_angle_q2), readout_len_q2)],
            "sine": [(np.cos(rotation_angle_q2), readout_len_q2)],
        },
