...
sys.path.append(r'C:\Users\quantum1\OneDrive\Documents\Python Scripts\Important Blue Fridge Python Files\New\OPX_setup_06022025\classifiers\classifier.py')
print(sys.path)
...
if simulate:
    ...
    def get_prob(I1,Q1,I2,Q2):
        IQ_df = pd.DataFrame({"I1": I1, "Q1": Q1, "I2": I2, "Q2": Q2})
        classified = classifier.classify(IQ_df)
        states = classified["predicted"]
        states_reshaped = classifier.reshape_for_exp(states, n_runs, 1)
        probabilties = classifier.probabilities(states_reshaped)
        return probabilties
    probabilties_g=get_prob(I1g,Q1g,I2g,Q2g)
    probabilties_e=get_prob(I1e,Q1e,I2e,Q2e)
    probabilties_f=get_prob(I1f,Q1f,I2f,Q2f)
